A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get Oldest Call Waiting
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-get-oldest-call-waiting-use-within-script-data-action-module.git?ref=v1.0.0"
    action_name        = "Get Oldest Call Waiting"
